...
int xcb_avm_adas_renderRectGroup(adas_auxiliary_type_t *adas_auxiliary, ViewParameter *view, 
void * pPointInfo, int nViewIndex, float *rect_color, int nWidth, int nHeight);
