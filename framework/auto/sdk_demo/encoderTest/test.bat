adb push %~dp0../../sdk_lib/lib64/libsdk_encoder.so /usr/lib
...
::adb shell encoderTest -i /tmp/input/800x480x93_nv21.yuv -o /tmp/output/800x480x93_nv21  -p 1 -f 1 -w 0 -t 1 
adb shell sync
